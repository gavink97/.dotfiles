# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="gavin"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/rw/01cpw1m90lsddspk0qb868cm0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/gavinkondrath/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/gavinkondrath/.mailcheckrc"
# }
...
# weather.sh {
	...
	export TMUX_POWERLINE_SEG_WEATHER_GREP="rg"
