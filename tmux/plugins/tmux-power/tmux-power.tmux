...
mac_icon="$(tmux_get '@tmux_power_user_icon' '󰘳')"
time_icon="$(tmux_get '@tmux_power_time_icon' '󰥔')"
date_icon="$(tmux_get '@tmux_power_date_icon' '󰸘')"
...
GC06=#BEC5B2 #bg5
GC07=#FFE7DE #bg_red
GC08=#FOF2D4 #bg_visual
GC09=#FEF2D5 #bg_yellow
GC10=#F3F5D9 #bg_green
GC11=#ECF5ED #bg_blue
GC12=#F85552 #red
GC13=#F57D26 #orange
GC14=#DFA000 #yellow
...
GC18=#DF69BA #purple
GC19=#5C6A72 #fg
GC20=#93B259 #statusline1
GC21=#708089 #statusline2
GC22=#E66868 #statusline3
GC23=#AGBOAO #gray1
GC24=#939F91 #gray2
GC25=#829181 #gray3
...
user=Gavin
LS="#[fg=$G04,bg=$TC,bold]  $user_icon #[fg=$TC,bg=$G06,nobold]$right_arrow_icon#[fg=$TC,bg=$G06] $time_format#[fg=$TC,bg=$G06] $session_icon #S #[fg=$G06,bg=$TC]$right_arrow_icon"
...
RS="#[fg=$G06]$left_arrow_icon#[fg=$TC,bg=$G06] $date_icon $date_format #[fg=$TC,bg=$G06]$left_arrow_icon#[fg=$G04,bg=$TC] $mac_icon #h "
...
# Pane border
tmux_set pane-border-style "fg=$TC,bg=default"

# Active pane border
tmux_set pane-active-border-style "fg=$TC,bg=$GC03"
